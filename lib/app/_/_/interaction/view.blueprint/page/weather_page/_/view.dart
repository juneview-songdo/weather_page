...
class NewViewState extends State<NewView> with StateMother {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Image.asset(
                              'assets/view/weather_page/11.webp',
                              scale: 8,
                            ),
                        ...
                        Row(
                          children: [
                            Image.asset(
                              'assets/view/weather_page/12.webp',
                              scale: 8,
                            ),
                            const SizedBox(width: 5),
                            Column(
                    ...
                    Row(
                      ...
                      children: [
                        Row(children: [
                          Image.asset(
                            'assets/view/weather_page/13.webp',
                            scale: 8,
                          ),
                          const SizedBox(width: 5),
                          Column(
                        ...
                        Row(children: [
                          Image.asset(
                            'assets/view/weather_page/14.webp',
                            scale: 8,
                          ),
                          const SizedBox(width: 5),
                          Column(
  ...
  Widget getWeatherIcon(int code) {
    switch (code) {
      case >= 200 && < 300:
        return Image.asset('assets/view/weather_page/1.webp');
      case >= 300 && < 400:
        return Image.asset('assets/view/weather_page/2.webp');
      case >= 500 && < 600:
        return Image.asset('assets/view/weather_page/3.webp');
      case >= 600 && < 700:
        return Image.asset('assets/view/weather_page/4.webp');
      case >= 700 && < 800:
        return Image.asset('assets/view/weather_page/5.webp');
      case 800:
        return Image.asset('assets/view/weather_page/6.webp');
      case > 800:
        return Image.asset('assets/view/weather_page/7.webp');
      default:
        return Image.asset('assets/view/weather_page/6.webp');
    }
  }
